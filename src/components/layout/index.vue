      ...
      <template #main>
        <div class="sykj-header_main">
          <div class="header-logo_wrap">
            ...
            <img
              class="header-main_logo"
              src="@/imgs/logo@1x.png"
              style="margin-left: 12px"
            />
          </div>
          <div class="header-route_wrap">
            <router-link to="/layout/out" tag="span" class="router-link_item"
              >外包管理</router-link
            >
            <router-link to="/layout/app" tag="span" class="router-link_item"
              >应用管理</router-link
            >
          </div>
        </div>
      ...
      <template #login>
        ...
        >
          <span class="el-dropdown-link">
            <span style="color: #409eff; font-size: 1.3rem">{{
              userInfo.role
            }}</span>
            <i
